...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_LOWER] = LAYOUT(
             ...
             _______, _______, KC_DSTP,   _______, _______, _______, KC_UNDS, KC_PLUS, KC_LCBR, KC_RCBR,  \
             _______, _______, _______,   _______, _______, _______, KC_INS,  _______, KC_HOME, KC_END,\
             KC_ALEN,          _______,   KC_BSCT, KC_BSCT, KC_SPC,  KC_SPC,  KC_ULCK
  ),
  ...
  [_RAISE] = LAYOUT(
             ...
             KC_SCEN,          KC_LOCK,   KC_BSCT, KC_BSCT, KC_SPC,  KC_SPC,  _______
  ),
